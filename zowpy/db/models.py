"""
Database Models - Modelos SQLAlchemy para estado da aplicação.

Compatível com operações assíncronas.
Baseado nos models do zowsuplib.
"""
...
class TaskMsg(Base):
    ...
    account = relationship("Account", back_populates="task_msgs", lazy="raise_on_sql")
...
class AccountState(Base):
    ...
    account = relationship("Account", back_populates="account_state", lazy="raise_on_sql")
