"""
Async CertMan - Gerenciador de certificados assíncrono.

Refatora CertMan do consonance para async com cache assíncrono.
"""
...
class AsyncCertMan:
    """Gerenciador de certificados assíncrono."""

    # Chave pública de longo prazo do WhatsApp
    WHATSAPP_LONG_TERM_PUBKEY = bytearray(
                [20, 35, 117, 87, 77, 10, 88, 113, 102, 170, 231, 30, 190, 81, 100, 55, 196, 162, 139,
                 115, 227, 105, 92, 108, 225, 247, 249, 84, 93, 168, 238, 107])


    async def is_valid(self, rs, certificate_data):
        """
        :param rs:
        :type rs: PublicKey
